...
// func initListeners(cx *_prototype.State, commandName string, initial bool) {
// 	cfg := cx.Config
// 	var e error
// 	var fP int
...
// 		cfg.DataDir.Set(appdata.Dir("_prototype", false))
// 	}
// 	T.Ln("datadir set to", *cfg.DataDir)
// }

// func initWalletFile(cx *_prototype.State) {
...
// 	if cfg.LogDir.V() != "" {
// 		// logi.L.SetLogPaths(*cfg.LogDir, "_prototype")
...
// func initParams(cx *_prototype.State) {
// 	network := "mainnet"
